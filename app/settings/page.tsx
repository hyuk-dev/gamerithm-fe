          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 order-1 lg:order-2">
              {activeSection === "account" && (
                <AccountSection onSave={handleSave} />
              )}
              {activeSection === "preferences" && (
                <PreferencesSection onSave={handleSave} />
              )}
...
function Sidebar({
  ...
  return (
    <Card className="bg-gray-900/50 border-gray-800 p-4 h-fit w-full lg:w-64 backdrop-blur-sm order-2 lg:order-1 lg:sticky lg:top-24">
      ...
      <Card className="bg-gray-900/50 border-gray-800 p-6 backdrop-blur-sm">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-gray-400">
              Email is synced from your Steam account
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-3">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Show games still in development
                </p>
              </div>
            ...
            <div className="flex items-center justify-between py-3">
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Include owned games in recommendations
                </p>
              </div>
  ...
  return (
    <Card className="bg-gray-900/50 border-gray-800 p-6 backdrop-blur-sm">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between py-4 border-b border-gray-800">
          <div>
            <Label htmlFor="analyzePlaytime">
              Allow AI to analyze my playtime
            </Label>
            <p className="text-sm text-gray-400">
        ...
        <div className="flex items-center justify-between py-4 border-b border-gray-800">
          <div>
            <Label htmlFor="shareRecommendations">
              Share recommendations with friends
            </Label>
            <p className="text-sm text-gray-400">
              Let friends see your recommended games
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Receive a weekly digest of your gaming activity
                </p>
              </div>
            </div>
          </div>
